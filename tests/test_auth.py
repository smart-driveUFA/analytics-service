...
async def test_request_auth_create_tpi(mock_requests):
    ...
    response = await request_auth_create_tpi(request_tpi_schemas, headers["Authorization"], 55.02, 22.201)
...
async def test_send_header_to_auth_service(mock_requests):
    ...
    response = await send_header_to_auth_service(headers["Authorization"], request_tpi_schemas)
